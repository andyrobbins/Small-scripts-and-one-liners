...
action = function(host, port)
	...
	-- Screenshots will be called screenshot-namp-<IP>:<port>.jpeg
        local filename = host.ip .. ":" .. port.number .. ".jpg"
	...
	local cmd = "timeout 10s wkhtmltoimage --quality 10 --height 1024 " .. prefix .. "://" .. host.ip .. ":" .. port.number .. " " .. filename .. " 2> /dev/null   >/dev/null"
